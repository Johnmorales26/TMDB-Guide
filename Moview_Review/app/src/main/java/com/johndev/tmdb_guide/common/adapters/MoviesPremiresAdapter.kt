...
import com.johndev.tmdb_guide.databinding.ItemPremiresBinding
import com.johndev.tmdb_guide.getImage

class MoviesPremiresAdapter(var moviesList: MutableList<Result>, private val listener: OnMovieListener) :
    RecyclerView.Adapter<MoviesPremiresAdapter.ViewHolder>(){

    lateinit var context: Context

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        context = parent.context
        val view = LayoutInflater.from(context).inflate(R.layout.item_premires, parent, false)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        val binding = ItemPremiresBinding.bind(view)
