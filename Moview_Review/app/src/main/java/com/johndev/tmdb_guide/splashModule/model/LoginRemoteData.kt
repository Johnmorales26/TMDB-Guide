package com.johndev.tmdb_guide.splashModule.model
...
import com.johndev.tmdb_guide.splashModule.viewModel.LoginViewModel.Companion.createSessionRes
import com.johndev.tmdb_guide.splashModule.viewModel.LoginViewModel.Companion.csWithLogin
import com.johndev.tmdb_guide.splashModule.viewModel.LoginViewModel.Companion.requestToken
        ...
        val request = JsonObjectRequest(Request.Method.POST,url,jsonObject,
            { response ->
                ...
                try {
                    ...
                    csWithLogin.value = RequestToken()
                }
            }, { error ->
                csWithLogin.value = RequestToken()
            })
